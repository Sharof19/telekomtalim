    ...
    return InkWell(
      onTap: () {
        AppNavigator.pushCourseInfo(
          context,
          courseId: item.id,
          initialData: courseInfoInitialDataFromMyCourseItem(item),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    item.titleFor(localeCode) ?? tr(context, TrKey.kurs),
                    maxLines: 2,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: titleColor,
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      backgroundColor: isDark
                          ? AppColors.courseProgressTrackDark
                  ...
                  Text(
                    completed != null && total != null && total > 0
                        ? '$completed/$total ${tr(context, TrKey.aktiv)} • '
